  ...
  module Clients
    module KuaileMahua
      describe :ArticleEntityLister do
        it 'is class' do
          LoyalSpider::Clients::Lengxiaohua::ArticleEntityLister.is_a?(Class)
        end

        let :the_clazz do
          LoyalSpider::Clients::Lengxiaohua::ArticleEntityLister
        end
        ...
        context '基本抓取测试' do
          ...
          it 'class paged fetch' do
            ...
            # result.fetch_options.url.should == 'http://www.kl688.com/newjokes/index_2.htm'
            result.fetch_options.url.should == 'http://lengxiaohua.com/'
          end
